...
class Program
{
    static void Main(string[] args)
    {
        ...
        var citiesfiltered = cities
            .Where(i => i.StartsWith("brandStartsWithLetter") && i.EndsWith("brandEndsWithLetter")).ToList();
        ...
        if (listLength > 5)
        {
            Console.WriteLine("The first and last element's of the list are: {0}, {1}", tricolor.First(),
                tricolor.Last());
        }
        ...
        secondgrade.Add(new Student()
            { StudentID = 4, StudentName = "John", Grade = studentGrades[1], StandardID = 2 });
        secondgrade.Add(new Student()
            { StudentID = 4, StudentName = "Arthur", Grade = studentGrades[1], StandardID = 2 });
        secondgrade.Add(
            new Student() { StudentID = 4, StudentName = "James", Grade = studentGrades[1], StandardID = 2 });
        ...
        internationalStudents.Add(new Student()
            { StudentID = 4, StudentName = "Ram", Grade = studentGrades[0], StandardID = 2 });
        internationalStudents.Add(new Student()
            { StudentID = 4, StudentName = "John", Grade = studentGrades[1], StandardID = 2 });
        internationalStudents.Add(new Student()
            { StudentID = 4, StudentName = "Arthur", Grade = studentGrades[2], StandardID = 2 });
