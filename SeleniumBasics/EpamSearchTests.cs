...
namespace Selenium_Basics
{
    ...
    public class EpamSearchTests
    {
        ...
        public void FindJobsEMEAAmericaApacInList()
        {
            ...
            var findJobsButton =
                _driver.FindElement(By.XPath(
                    "//*[@class = 'arrow']//ancestor::*[contains (@href, 'job-listings') and @tabindex = '0']"));
            findJobsButton.Click();
            var regionesOnThePage =
                _driver.FindElements(By.XPath("//*[contains(@class,'tabs-23__title js-tabs-title')]"));
            ...
            bool areRegionsPresent =
                regionesOnThePageList.SequenceEqual<string>(regionesShouldBePresent, StringComparer.OrdinalIgnoreCase);
        ...
        public void VerifySearchWorksCorrectly()
        {
            ...
            var searchIconLocator =
                _driver.FindElement(By.XPath("//span[contains(@class,'dark-iconheader-search__search-icon')]"));
            ...
            var findButtonLocator =
                _driver.FindElement(By.XPath("//button/*[@class='bth-text-layer' and contains(text(), 'Find')]"));
            findButtonLocator.Click();
            string actualUrl = _driver.Url;
            Assert.That(actualUrl, Is.EqualTo(linkToVerify + textToSearchinUrl),
                "Link with search parameter is incorrect");
        ...
        public void VerifyTitleOnSearchResultsMatchArticlePageTitle()
        {
            ...
            var titleOfTheFirstArticleResults = titleOfTheFirstArticleResultsLocator.GetAttribute("innerText");
            titleOfTheFirstArticleResultsLocator.Click();
            var titleOnTheArticlePage = _driver.FindElement(By.XPath("//*[@class='font-size-80-33']")).GetAttribute("innerText");
            Assert.AreEqual(titleOfTheFirstArticleResults, titleOnTheArticlePage,
                "Titles on the results page and on the article page don't match");
        }
